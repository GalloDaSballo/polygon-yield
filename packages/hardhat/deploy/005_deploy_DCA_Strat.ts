...
import { MyieldDCAVault, AAVEUSDCRewards } from "../typechain";
...
const func: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
    ...
    const WANT = "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174";
    /** Construct Vault */
    const vault = await deployments.deploy("MyieldDCAVault", {
      from: deployer,
      args: [
        WANT, // Want / USDC
        "0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD6" //Need / wBTC
      ],
      log: true
    })
    ...
    const vaultInstant = await hre.ethers.getContractAt("MyieldDCAVault", vault.address) as MyieldDCAVault;
