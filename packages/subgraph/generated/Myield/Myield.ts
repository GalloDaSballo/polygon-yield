...
export class Myield extends ethereum.SmartContract {
  static bind(address: Address): Myield {
    return new Myield("Myield", address);
  }
  ...
  fromSharesToWithdrawal(amount: BigInt): BigInt {
    let result = super.call(
  ...
  try_fromSharesToWithdrawal(amount: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "fromSharesToWithdrawal",
      "fromSharesToWithdrawal(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(amount)]
